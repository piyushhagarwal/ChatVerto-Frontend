...
export default function TextMessageWithListNode({ id, data }: NodeProps) {
  ...
  return (
    <div className="relative w-full max-w-sm pr-2">
      ...
      <Card className="shadow-md border w-full overflow-visible">
        <CardHeader>
          <CardTitle className="text-lg">Text Message with List</CardTitle>
        </CardHeader>
        <CardContent>
